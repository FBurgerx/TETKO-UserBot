    ...
    async def on_load(self) -> None:
        ...
        config_dict = await self.kernel.get_module_config(
            self.name,
            {
                ...
                "info_banner_url": f"https://raw.githubusercontent.com/hairpin01/TETKO/refs/heads/{branch}/img/info.jpg",
            },
        )
    ...
    config = ModuleConfig(
        ...
        ConfigValue(
            ...
            description=(
                ...
                "{tetko_emoji}, {user_id}, {me_first_name}, {me_username},\n"

...
class KernelCoreMixin:
    ...
    def _init_paths(self) -> None:
        ...
        self.MODULES_REPO = (
            "https://raw.githubusercontent.com/anhedonuya/repo-TETKO-UserBot/main/"
        )
        self.UPDATE_REPO = "https://raw.githubusercontent.com/anhedonuya/TETKO-UserBot/main/"
    ...
    def _unmark_command_event_processed(self, event: Event) -> None:
        key = self._command_event_key(event)
        if key is None:
            return
    ...
    def iter_history_batches(self, entity, *args, **kwargs) -> Any:
        """Iterate history in batches using Telethon-TETKO helpers."""
        return self.client.iter_history_batches(entity, *args, **kwargs)

    async def export_history(self, entity, *, output, **kwargs) -> Any:
        """Export chat history using Telethon-TETKO high-level helpers."""

...
class KernelLifecycleMixin:
    ...
    async def _run_impl(self) -> None:
        ...
        if not no_web:
            try:
                web_via_env = os.environ.get("TETKO_WEB", "0") == "1"
            ...
            try:
                ...
                if e.errno == _errno.EADDRINUSE:
                    msg = (
                        ...
                        "Stop the process occupying it and restart TETKO."
                    )
                    print(f"\n❌  {msg}\n", flush=True)
